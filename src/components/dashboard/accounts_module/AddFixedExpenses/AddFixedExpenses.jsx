              ...
              <div className={`${addFixedExpenses.container} `}>
                    ...
                    <div className={`${addFixedExpenses.inputAreaTwoContainer}`}>
                        <div style={{display: `${otherExpensesData?.date ? 'block' : 'none'}`}}>
                         ...
                         <p>Cash+Bank+Bkash+Nogod+Rocket : {profitExpenseData?.result?.cashProfit}+{profitExpenseData?.result?.bankProfit}+{profitExpenseData?.result?.bkashProfit}+{profitExpenseData?.result?.totalProfit}+{profitExpenseData?.result?.nogodProfit}+{profitExpenseData?.result?.rocketProfit}</p>
                         <br />           
