...
export const fetchGetProductOldData = async (query, from, to, priceFrom, priceTo) => {
    try {
        ...
        const result = await axios.get(`${url}/products/old?searchTerm=${value}&from=${fromDate}&to=${toDate}&priceFrom=${fromPrice}&priceTo=${toPrice}`, {
            headers: {
                Authorization: token,
...
export const fetchGetProductData = async (query, from, to, priceFrom, priceTo, page, limit, inStock) => {
    ...
    try {
        ...
        const result = await axios.get(`${url}/products?searchTerm=${value}&from=${fromDate}&to=${toDate}&priceFrom=${fromPrice}&priceTo=${toPrice}&inStock=${inStock}&page=${page}&limit=${limit}`, {
            headers: {
                Authorization: token,
                "Accepts": "application/json",
                "Access-Control-Allow-Origin": "*"
...
export const fetchGetProductDataByBarcode = async (barcode) => {

    try {
        const token = localStorage.getItem('user')

        const result = await axios.get(`${url}/products/findByBarcode/${barcode}`, {
            headers: {
                Authorization: token,
                "Accepts": "application/json",
                "Access-Control-Allow-Origin": "*"
